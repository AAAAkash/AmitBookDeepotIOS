...
class BaseApiManager: NSObject {
    ...
    let sessionManager: Session = {
        guard let url = APIUrl.baseUrlWithOutHttp?.replacingOccurrences(of: " ", with: "") else { return Session.default }
...
//        var _requiresPinning = requiresPinning
//        if !isProduction {
//            _requiresPinning = false
//        }
...
//        if _requiresPinning {
//            dataRequest =  BaseApiManager.sharedInstance.sessionManager.request(url,
//                                                                                method: method,
//                                                                                parameters: params,
//                                                                                encoding: encoding,
//                                                                                headers: httpHeaders)
//        } else {
            dataRequest = AF.request(url,
                                     ...
                                     headers: httpHeaders)
//        }
        debugPrint("URl:---", dataRequest.request?.url)
//        print(url)
